...
export default function PlaygroundMessages({}: Props) {
  ...
  // const { messages, loading, submit, streamCompleted, resetLoading } = useOpenAI();
  ...
  const { messages, loading: globalLoading, submit } = useOpenAI();  
  ...
  // // Add this useEffect to reset the loading state when the stream is completed  
  // useEffect(() => {
  //   if (streamCompleted) {
  //     resetLoading();
  //   }
  // }, [streamCompleted, resetLoading]);
